...
const COMPANIES_DEF = [
  ...
  { id: 'sky-ship',    name: 'SkyShip',   ticker: 'SKY',   sector: 'logistics',   emoji: '🚁', desc: 'Autonomous drone delivery network',                  basePrice: 85,  _revGrowth: 0.28, _profitMargin: 0.08,  _debtRatio: 0.45, _founderScore: 0.72, _rdSpend: 0.60,
    ceo: { name: 'Elena Torres', rating: 'A-', quote: 'Logistics is the last industry that still runs on clipboards.', background: 'Ex-Amazon logistics VP. Rebuilt SkyShip from near-bankruptcy in 2021 by cutting 40% of burn.' },
    analystRating: 'BUY', targetPrice: 118, pe: 131, beta: 1.4, marketCap: '820M' },
  { id: 'fusion-grid', name: 'FusionGrid',ticker: 'FGRD',  sector: 'energy',      emoji: '⚡', desc: 'Next-generation clean energy infrastructure',        basePrice: 95,  _revGrowth: 0.18, _profitMargin: 0.15,  _debtRatio: 0.55, _founderScore: 0.65, _rdSpend: 0.70,
    ceo: { name: 'Dr. James Okoro', rating: 'B+', quote: 'The grid is a political problem dressed up as an engineering one.', background: 'MIT energy physicist. Carries 55% debt-to-assets but has secured government grid contracts worth ₳900M.' },
    analystRating: 'HOLD', targetPrice: 102, pe: 24, beta: 0.7, marketCap: '950M' },
  { id: 'neuro-link',  name: 'NeuroLink', ticker: 'NLK',   sector: 'biotech',     emoji: '🧠', desc: 'Brain-computer interface technology',                basePrice: 200, _revGrowth: 0.55, _profitMargin: -0.10, _debtRatio: 0.20, _founderScore: 0.95, _rdSpend: 0.95,
    ceo: { name: 'Dr. Maya Chen', rating: 'A+', quote: 'We are not building a product. We are building a new sensory organ for humanity.', background: 'Stanford neuroscience PhD, ex-DARPA. Personal stake ₳320M. Considered the most visionary CEO in biotech.' },
    analystRating: 'BUY', targetPrice: 340, pe: null, beta: 2.1, marketCap: '2.0B' },
  { id: 'aqua-gen',    name: 'AquaGen',   ticker: 'AQG',   sector: 'environment', emoji: '💧', desc: 'Water purification and distribution technology',     basePrice: 75,  _revGrowth: 0.12, _profitMargin: 0.22,  _debtRatio: 0.15, _founderScore: 0.78, _rdSpend: 0.40,
    ceo: { name: 'Priya Singh', rating: 'A', quote: 'Water is the one resource no government can ignore. That is our moat.', background: 'Civil engineer turned CEO. Bootstrapped AquaGen to profitability with zero VC money. Low debt, consistent dividends.' },
    analystRating: 'BUY', targetPrice: 94, pe: 18, beta: 0.5, marketCap: '680M' },
  { id: 'titan-bot',   name: 'TitanBot',  ticker: 'TITAN', sector: 'robotics',    emoji: '🦾', desc: 'Industrial automation and robotics systems',         basePrice: 110, _revGrowth: 0.22, _profitMargin: 0.18,  _debtRatio: 0.30, _founderScore: 0.70, _rdSpend: 0.55,
    ceo: { name: 'Klaus Werner', rating: 'A-', quote: 'A robot that replaces one job creates three safer ones. History proves this.', background: 'Ex-Kuka robotics engineer. Steady operator — no moonshots, just compounding margins. Known for conservative guidance.' },
    analystRating: 'BUY', targetPrice: 142, pe: 29, beta: 1.1, marketCap: '1.1B' },
  { id: 'med-vault',   name: 'MedVault',  ticker: 'MEDV',  sector: 'biotech',     emoji: '💊', desc: 'AI-driven drug discovery platform',                  basePrice: 145, _revGrowth: 0.35, _profitMargin: -0.05, _debtRatio: 0.25, _founderScore: 0.82, _rdSpend: 0.90,
    ceo: { name: 'Dr. Rachel Stern', rating: 'A', quote: 'We cut drug discovery from 12 years to 18 months. That is the whole pitch.', background: 'Oxford pharmacology doctorate, ex-Pfizer AI lab lead. Two Phase 3 trials in progress. Market watches every FDA update.' },
    analystRating: 'BUY', targetPrice: 210, pe: null, beta: 1.7, marketCap: '1.5B' },
  { id: 'orbital-x',  name: 'OrbitalX',  ticker: 'ORB',   sector: 'space',       emoji: '🛸', desc: 'Low-orbit satellite internet constellation',         basePrice: 180, _revGrowth: 0.60, _profitMargin: -0.20, _debtRatio: 0.65, _founderScore: 0.90, _rdSpend: 0.85,
    ceo: { name: 'Kai Nakamura', rating: 'A+', quote: 'Every corner of Earth deserves a gigabit connection. We will deliver it.', background: 'Former SpaceX propulsion engineer. High-debt, high-ambition play — 64 satellites launched, profitability projected in 18 months.' },
    analystRating: 'BUY', targetPrice: 295, pe: null, beta: 2.4, marketCap: '1.8B' },
  { id: 'verde-pact',  name: 'VerdePact', ticker: 'VPCT',  sector: 'environment', emoji: '🌱', desc: 'Sustainable agriculture and crop technology',        basePrice: 68,  _revGrowth: 0.15, _profitMargin: 0.12,  _debtRatio: 0.20, _founderScore: 0.75, _rdSpend: 0.45,
    ceo: { name: 'Sofia Alvarez', rating: 'A', quote: 'Feeding 10 billion people is the hardest engineering problem no one talks about.', background: 'Agritech entrepreneur from rural Mexico. Two exits. VerdePact is her third company — most profitable of the three.' },
...
const STARTUPS_DEF = [
  ...
  { id: 'nano-forge', name: 'NanoForge', ticker: 'NANO', sector: 'materials', emoji: '🔬', desc: 'Nanomaterial manufacturing — tiny but growing', basePrice: 15, _revGrowth: 0.80, _profitMargin: -0.30, _debtRatio: 0.40, _founderScore: 0.70, _rdSpend: 0.75, isStartup: true, _volatility: 0.20,
    ceo: { name: 'Diana Park', rating: 'A-', quote: 'Materials science is where the next 100 trillion-dollar industries are hiding.', background: 'Caltech materials scientist. Revenue growing fast but path to profit depends on scaling the core synthesis process.' },
    analystRating: 'BUY', targetPrice: 28, pe: null, beta: 2.6, marketCap: '95M' },
  { id: 'psi-labs',   name: 'PsiLabs',   ticker: 'PSI',  sector: 'biotech',   emoji: '🧬', desc: 'Gene therapy pioneer — FDA trial pending',     basePrice: 25, _revGrowth: 0.0,  _profitMargin: -0.60, _debtRatio: 0.50, _founderScore: 0.85, _rdSpend: 0.95, isStartup: true, _volatility: 0.30,
    ceo: { name: 'Dr. Amir Hassan', rating: 'A', quote: 'One approval changes everything. We have five shots on goal.', background: 'Johns Hopkins gene therapy pioneer. FDA trial results pending — positive outcome would triple the share price overnight.' },
    analystRating: 'SPECULATIVE', targetPrice: 70, pe: null, beta: 3.8, marketCap: '120M' },
]
